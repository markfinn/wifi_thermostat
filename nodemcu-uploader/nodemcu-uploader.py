...
class Uploader:
    ...
    def write_file(self, path, destination, comp):
    ...
    def file_restart(self, stop):
        log.info('restart %s'%stop)
...
if __name__ == '__main__':
    ...
    file_parser.add_argument('cmd', choices=('list', 'format', 'restart', 'restartandstop'))
    ...
    if args.operation == 'upload':
        ...
        if args.cmd == 'list':
            ...
            uploader.file_restart(False)
        elif args.cmd == 'restartandstop':
            uploader.file_restart(True)
